...
import { useNavigate, useLocation } from "react-router-dom";import { initializeSocket, receiveMessage, sendMessage } from '../config/socket'
...
const Project = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      axios.get('/users/all', {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}` // or another method of storing tokens
        }
      })
      .then((res) => {
